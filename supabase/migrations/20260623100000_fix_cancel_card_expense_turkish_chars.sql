-- cancel_card_expense hata mesajlarındaki ASCII Türkçe karakterleri düzelt.
-- Diğer RPC'ler 20260621200000'de düzeltilmişti; bu fonksiyon atlanmıştı.
...
begin
  ...
  values (
    ...
    'card_expenses',
    v_expense.id,
    'Mutabakat sırasında iptal edildi. Orijinal tarih: ' || to_char(v_expense.spent_at, 'YYYY-MM-DD')
  );

-- Kismi provizyon kesinlesmesinde bağlam etiketi kayboluyordu.
--
-- post_card_provision, tutarin bir kismi kesinlestiginde ORIJINAL satiri kalan
-- provizyon olarak birakip kesinlesen kisim icin YENI bir card_expenses satiri
-- aciyor. Yeni satira context_id kopyalanmadigi icin, provizyonu bir gider
-- baglamina etiketlemis olsan bile kesinlesen kisim "baglamsiz" doguyordu; yani
-- baglam ozetleri (posted satirlari toplar) parayi hic gormuyordu. Tam
-- kesinlesme yolunda ayni satir guncellendigi icin bu sorun yoktu.
--
-- Fonksiyonun geri kalani 20260528062250 ile ayni; tek fark insert'e eklenen
-- context_id sutunu.

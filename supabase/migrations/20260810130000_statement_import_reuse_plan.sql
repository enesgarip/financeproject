-- Faz BM-2 / K1: Süregiden taksit planı importta yeniden kullanılır.
--
-- Kök neden: SI-10 "sil-yeniden kur" modeline geçerken RPC'deki korunan-parent
-- yeniden kullanım dalı (existingExpenseId) UI'dan hiç beslenmedi. Ödenmiş
-- geçmişi olan parent silinmekten korunur ama carryover fallback'i her aylık
-- importta AYNI plana yeni bir parent harcama açar: borç doğru kalır, harcama
-- listesi/kategori analizi/işlem geçmişi ay be ay mükerrerleşir.
--
-- Çözüm sunucudadır (istemci eşleştirmesi değil): carryover aksiyonu parent id
-- taşımıyorsa aynı kartta aynı taksit adedi + birebir açıklama + ödenmiş/settled
-- geçmişli parent aranır; tam olarak TEK aday varsa mevcut korunan dal ile
-- yeniden kullanılır (açık plan child'ları o parent'a kurulur). Belirsizlik
-- bugünkü davranışa (yeni parent) düşer. Tutar toleransı bilinçli olarak
-- eşleşme kriteri DEĞİLDİR: SI-07 parent toplam farkını korunan dalda not ile
-- kabul eder; farkı eşleşme engeli yapmak K1'i drift'li planlarda geri getirirdi.

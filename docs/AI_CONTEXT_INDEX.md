...
| `/analiz/asistan` AI asistan | `src/pages/AssistantPage.tsx` | `src/app/useAiChat.ts`, `src/data/repositories/aiChatRepo.ts`, `src/lib/aiChatClient.ts`, `src/utils/aiContext.ts`, `supabase/functions/ai-chat` |

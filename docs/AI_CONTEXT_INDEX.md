...
| **Yedek / backup** | `utils/backup.ts` (+ `backup.test.ts`; ledgers ve operasyon logları export-only, alias/dismiss/push restore edilir) | `data/repositories/backupRepo.ts` | (DataHealth) |

...
| **Nakit akış takvimi (tam ay)** | `utils/fullMonthCalendar.ts` | — | `pages/AnalysisPage.calendar.tsx` (FullMonthCalendarPanel; geçmiş günler soluk, bakiye yalnız bugünden ileri) |

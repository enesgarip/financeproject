...
| **Ekstre tahmini (kesime az kala)** | `utils/statementEstimate.ts` (+test; ≤5 gün kala "kapanırsa ~₺X" = dönem içi kova + o ekstre ayının planlı taksitleri; "~" bilinçli — provizyon/faiz bilinemez) | — | `pages/CardsPage.list.tsx` (kredi kartı satırında CardDatum) |

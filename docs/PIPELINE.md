...
GitHub runner'da görülen `NO_FCP` flake'ini azaltır. Lighthouse job'ı da
Playwright smoke testleriyle aynı `mcr.microsoft.com/playwright:v1.60.0-noble`
container'ında çalışır ve LHCI'ye Playwright Chromium'u `CHROME_PATH` ile
gösterir; böylece GitHub runner'ın değişken sistem Chrome kanalına bağlı kalmaz.

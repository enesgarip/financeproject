...
export function Layout() {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-[#f7f8f4] text-stone-900 dark:bg-stone-950 dark:text-stone-100">
      ...
      <main className="mx-auto w-full max-w-xl flex-1 px-4 pb-5 pt-4">
        <Outlet />
      </main>
      <BottomNav />
    </div>

...
export function BottomNav() {
  return (
    <nav className="sticky inset-x-0 bottom-0 z-30 mt-auto border-t border-stone-200 bg-white/95 px-2 pb-[max(env(safe-area-inset-bottom),0.35rem)] pt-1.5 shadow-[0_-10px_30px_rgba(15,23,42,0.08)] backdrop-blur dark:border-stone-800 dark:bg-stone-950/95 dark:shadow-[0_-10px_30px_rgba(0,0,0,0.35)]">

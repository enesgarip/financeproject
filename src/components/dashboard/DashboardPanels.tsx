...
export function FinancialHealthPanel({ health, goalProgress }: { health: FinancialHealthSummary; goalProgress: GoalProgressSummary }) {
  const toneClass = {
...
export function ScenarioSimulator({ cashFlow, netWorth }: { cashFlow: CashFlowSummary; netWorth: number }) {
...
export function PeriodDebtTotalsPanel({ cashFlow }: { cashFlow: CashFlowSummary }) {
  return (
    <Card className="border-0 shadow-[var(--shadow-card)] ring-1 ring-border/80">
      <CardHeader className="pb-2">
        <CardTitle className="inline-flex items-center gap-1.5">
...
export function NextMonthLoadPanel({ load }: { load: MonthlyLoadSummary }) {

...
import type { Car, CarExpense, CardExpense, InsertFor, UpdateFor } from '../../types/database'
import {
 ...
 */
export async function setCardExpenseCar(expenseId: string, carId: string | null): Promise<Result<void>> {
